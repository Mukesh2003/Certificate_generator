...
if(isset($_POST["Transfer_certificate"])){
    ...
    if(isset($_POST['save'])){
        ...
        $query="UPDATE samplestudent SET Student_Name='$name',Student_Sur_Name='$sur_name',Father_Name='$father_name',Father_Sur_Name='$father_sur_name',Course='$course',Course_start_date='$strt_date',Course_end_date='$end_date',Conduct='$conduct' where RollNumber='$idd'";
